...
Example: **from:twitterdev -has:hashtags****has:cashtags**Conjunction requiredAdvancedMatches Tweets that contain a cashtag symbol (with a leading ‘$’ character. For example, **$tag**).  
