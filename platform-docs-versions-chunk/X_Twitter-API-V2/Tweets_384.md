...
| `created_at` | date (ISO 8601) | Creation time of the Tweet. For example: `2020-12-10T20:00:10Z`  <br>  <br>To return this field, add `tweet.fields=created_at` in the request's query parameter. |
