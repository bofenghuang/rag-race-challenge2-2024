...
HTTPPHP SDKJavaScript SDKAndroid SDKiOS SDK[Graph API Explorer](https://developers.facebook.com/tools/explorer/?method=GET&path=%7Bcommerce-merchant-settings-id%7D%2Fcommerce_payouts&version=v19.0)

    GET /v19.0/{commerce-merchant-settings-id}/commerce_payouts HTTP/1.1
